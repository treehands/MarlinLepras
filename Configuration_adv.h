...
//#define CUSTOM_MENU_MAIN
  ...
  //#define CUSTOM_MENU_MAIN_TITLE "Filamento"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 User Script Done"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Cargar filamento"
  #define MAIN_MENU_ITEM_1_GCODE "M701"
  #define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Sacar filamento"
  #define MAIN_MENU_ITEM_2_GCODE "M702"
  #define MAIN_MENU_ITEM_2_CONFIRM          // Show a confirmation dialog before this action
  
  #define MAIN_MENU_ITEM_3_DESC "Limpiar punta"
  #define MAIN_MENU_ITEM_3_GCODE "G12 P1 S2 T4"
 ...
 */
  ...
  #define SERVICE_WARNING_BUZZES  2
